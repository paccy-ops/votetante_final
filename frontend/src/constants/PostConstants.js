...
export const POST_CREATE_VOTE_REQUEST = 'POST_CREATE_VOTE_REQUEST';
export const POST_CREATE_VOTE_SUCCESS = 'POST_CREATE_VOTE_SUCCESS';
export const POST_CREATE_VOTE_FAIL = 'POST_CREATE_VOTE_FAIL';
export const POST_CREATE_VOTE_RESET = 'POST_CREATE_VOTE_RESET';